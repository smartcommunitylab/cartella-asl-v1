...
import it.smartcommunitylab.cartella.asl.model.ext.ProfessoriClassi;
...
public class InfoTnImportProfessoriClassi {
	...
	public void updateProfessoriClassi(MetaInfo metaInfo) throws Exception {
		...
		if (response != null && !response.isEmpty()) {
			...
			professoriClassiRepository.save(tobeSaved);
	...
	private ProfessoriClassi convertToLocalProfessorClassBean(ProfessorClassInfoTn professorClass)
		...
		result.setDateFrom(sdf.parse(professorClass.getDatefrom()));
		result.setDateTo(sdf.parse(professorClass.getDateto()));
