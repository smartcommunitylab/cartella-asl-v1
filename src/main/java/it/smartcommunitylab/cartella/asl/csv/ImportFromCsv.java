			...
			while((line = in.readLine()) != null) {
				try {
					...
					if(aslUser == null) {
						...
						aslUser.getRoles().add(new ASLUserRole(ASLRole.STUDENTE, studente.getId()));
...
//						aslUser.setCf(cf);
						aslUser.setEmail(email);
						aslUser.getRoles().add(new ASLUserRole(ASLRole.FUNZIONE_STRUMENTALE, istituzione.getId()));
