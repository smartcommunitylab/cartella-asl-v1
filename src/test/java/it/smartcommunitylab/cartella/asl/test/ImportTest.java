...
public class ImportTest {
	...
	@Autowired
	private OppCorsoRepository ocRepository;
	...
	@Autowired
	private AnnoAlternanzaRepository anaRepository;

	@Autowired
	private CorsoDiStudioRepository cdsRepository;

	@Autowired
	private CorsoInternoRepository ciRepository;
	...
	public void t1ImportAzienda() throws Exception {
		...
		aziende.forEach(x -> aslManager.saveAzienda(x));
