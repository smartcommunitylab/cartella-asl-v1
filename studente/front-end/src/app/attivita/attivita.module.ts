...
import { NoteStudenteEditModalComponent } from './attivita-detail/modals/note-studente-edit-modal/note-studente-edit-modal.component';
import { DocumentUploadModalComponent } from './attivita-detail/modals/document-upload-modal/document-upload-modal.component';
...
@NgModule({
  ...
  declarations: [AttivitaComponent, AttivitaGuideComponent, AttivitaListComponent, AttivitaDetailComponent, AttivitaPresenzeComponent, NoteStudenteEditModalComponent, DocumentUploadModalComponent],
  entryComponents: [
    NoteStudenteEditModalComponent,
