...
import { CompetenzeCancellaModal } from './cancella-competenze/competenze-cancella-modal.component';
  ...
  deleteCompetenza(deleted, $event) {
    ...
    modalRef.result.then((result) => {
      if (result == 'DEL') {
        ...
        this.dataService.updateCompetenzeAzienda(this.offer.id, updatedCompetenze)
