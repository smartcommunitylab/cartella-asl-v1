...
@Component({
  selector: 'cm-select-students-gruppo-incorso',
  templateUrl: './select-students.component.html',
  styleUrls: ['./select-students.component.scss']
})
export class SelectStudentsGruppo implements OnInit {
      ...
      this.dataService.completaAttivitaAlternanza(id, upldatedES)
        .subscribe((status: boolean) => {
          if (status) {
            ...
            this.router.navigate(['azienda/attivita/incorso/gruppo']);
          } else {
